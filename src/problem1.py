...
def run_test_problem1a():
    ...
    # Test 3:
    expected = -1.654  # This is APPROXIMATELY the correct answer.
    answer = problem1a(3,9)
    print()
    print('Test 3 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 4:
    expected = 1.254  # This is APPROXIMATELY the correct answer.
    answer = problem1a(66, 88)
    print()
